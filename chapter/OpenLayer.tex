...
\subsection {Markers}
Markers base layer sangat mudah diaplikasikan dan pemakaian fungsi addMarkers untuk menambah marker pada layer. Makaers hanya mendukung point/ titik.

\subsection {Text}
Text layer merupakan data-data dengan format Teks dan menampilkan hasilnya sebagai marker yang dapat diklik. Layer teks merupakan subclass dari Marker layer, dan tidak mendukung format garis atau polygon.
...
\subsection {WFS}
Untuk informasi API selengkapnya lihat pada WFS Layer API Docs.
Generic Subclasses
EventPane
FixedZoomLevels
Grid
...
Controls adalah OpenLayers classes yang mempengaruhi kondisi dari peta atau menampilakan informasi tambahan kepada user. Control sebagai antar mukan utama dengan peta.
