...
Adapun Kekurangan yang dimiliki oleh data raster adalah :
	\begin{enumerate}
		...
		\item metode untuk medapatakan format data vektor melalui proses yang lama, cukup melelahkan dan relative mahal.\cite{irwansyah2013sistem}
	\end{enumerate}
	...
	\begin{itemize}
		\item  Run Length Encoding
				...
				\begin{figure} [ht]
					...
					Gambar \ref{runlengthencoding} ini adalah contoh gambar pada Run Length Encoding
				\end{figure}
		...
		\item  Block Encoding
				...
				\begin{figure} [ht]
					...
					\label{blockencoding}
					Gambar \ref{blockencoding} ini adalah contoh gambar Block Encoding
				\end{figure}
		...
		\item  Quadtree Data Structure
				...
				\begin{figure} [ht]
					...
					Gambar \ref{quadtreedatastructure} ini adalah contoh gambar Quadtree Data Structure
				\end{figure}
	\end{itemize}
