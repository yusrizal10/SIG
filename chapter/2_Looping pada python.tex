...
\subsection{Struktur Dasar Perulangan}
Struktur Dasar Loops adalah sebagai berikut :
1) Menginisialisasi kontrol.
	a) Kontrol - biasanya sebuah variabel yang menentukan apakah perulangan dijalankan atau tidak. 
2) Menguji kontrol terhadap kondisi berhenti .
3) Mengeksekusi body perulangan (bagian yang akan diulang) .
4) Memperbarui nilai kontrol.
...
\subsection{Post-test loop}
Post-test loop adalah sebuah perulangan yang akan mengeksekusi bagian akhir body atau menempatkan pengujian akhirnya menjadi hal terakhir pada body. 
