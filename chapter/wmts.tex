...
\begin{equation}
	    [server]=[layer]=[time]=[x]=[y]=[zoom].png (1)
\end{equation}
...
\centerline{\includegraphics[width=1\textwidth]{figures/figure1_wmts.png}}
...
\begin{equation}
	    xtile = \frac{lon + 180}{360} \ 2^zoom (2)
\end{equation}
\begin{equation}
	    ytile =\frac{1-log (tan(lat_rad) + \frac{1}{cos(lat_rad)})}{2pi} \ 2^zoom (3)
\end{equation}
